                    ...
                    >
                        <ul>
                            ...
                            {/* <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/AquaNotch.lb/"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
                        ...
                        <div className="text">
                            <div className="column mb-5"  >
                                <p className="question myGray">
                                    ...
                                    <span>
                                        Contact{" "}
                                        <a
                                            href="mailto:info@AquaNotch-lb.com"
                                            data-auto-id="true"
                                            id="page-footer-mailto-support-bellroy-com-1"
                                            className='myGray'
                                        >
                                            info@AquaNotch-lb.com
                                        </a>
                                    </span>
                                </p>
                            </div>
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} AquaNotch
                                </span>
                            </div>
                        </div>
                    </div>
